      ...
      <div className='bg-white border-2 border-gray-300 rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll'>
...

        {
          appointments.map((item, index) => {
            return (
              <div className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center text-gray-500 px-6 py-2 border-b border-gray-300 hover:bg-gray-50' key={index}>
