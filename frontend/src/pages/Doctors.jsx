  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className='w-full grid md:grid-cols-[var(--grid-template-columns)] grid-cols-[var(--grid-template-columns-mobile)] gap-4 gap-y-6'>
          {
            filterDoc.map((item, index) => (
              <div onClick={() => navigate(`/appointment/${item._id}`)} key={index} className='border border-blue-200 rounded-xl overflox-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500'>
